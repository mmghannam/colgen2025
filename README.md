...
$$
\begin{align}
    \min_{x,y} & \quad \sum_{b \in \mathcal{B}} y_b \quad & (1) \\
...
$$
\begin{align*}
\text{minimize} & \quad \sum_{p \in \mathcal{P}} z_p \quad & (1) \\
\text{subject to} & \quad \sum_{p \in \mathcal{P}} a_i^{p} z_p = 1, \quad \forall i \in I \quad & (2) \\
& \quad z_p \in \lbrace0, 1\rbrace, \quad \forall p \in \mathcal{P} \quad & (3) 
\end{align*}
$$
...
$$
\begin{align*}
\text{minimize} & \quad 1 - \sum_{i \in I} a_i\pi_i \quad & (1) \\
\text{subject to} & \quad \sum_{i \in I} s_i a_i \leq C \quad & (2) \\
